...
const mainPageSubSubTitle = document.querySelector('.js_sub-sub-title');
const MAIN_TAGLINE = 'The evolution continues.';
const SECONDARY_TAGLINE = 'Simply better shopping.';
const THIRDLY_TAGLINE = 'Online shopping is the best way to buy everything you need in two clicks.';
if(mainPageTitle) {
...
if(mainPageSubSubTitle) {
    mainPageSubSubTitle.textContent = THIRDLY_TAGLINE;
}
